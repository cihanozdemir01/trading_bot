...
const BACKEND_URL = "http://127.0.0.1:8000"; // Android emulator için http://10.0.2.2:8000 veya yerel IP kullanılabilir

export default function App() {
  const [activeTab, setActiveTab] = useState('strategy'); // 'strategy', 'ai', 'history'
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* ÜST BAŞLIK & CANLI BAĞLANTI İKONU */}
      <View style={styles.header}>
        <View style={styles.logoRow}>
          ...
          <View>
            ...
            <Text style={styles.appSubTitle}>Profesyonel Ticaret & AI Danışmanı</Text>
          </View>
        </View>
        <View style={styles.liveBadge}>
          <View style={styles.liveDot} />
          <Text style={styles.liveText}>Binance Canlı</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  appTitle: { color: '#f3f4f6', fontSize: 18, fontWeight: '700' },
  appSubTitle: { color: '#9ca3af', fontSize: 11 },
